...
module "vnet" {
  ...
  subnets = {
    management = { name = "management-subnet", address_prefixes = ["10.10.0.0/24"], create_nsg = true }
    application = { name = "application-subnet", address_prefixes = ["10.10.1.0/24"], create_nsg = true }
    data = { name = "data-subnet", address_prefixes = ["10.10.2.0/24"], create_nsg = true }
    privateendpoint = { name = "private-endpoint-subnet", address_prefixes = ["10.10.3.0/24"] }
